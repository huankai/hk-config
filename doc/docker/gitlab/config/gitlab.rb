...
# -----------------------------------------------------------------------------
#配置http 协议访问的地址，
# 默认下，nginx监听的端口为external_url中定义的，或者默认的80/443。所以这里nginx是监听的8085端口。而docker run的时候是暴露的80端口，所以根本就访问不了。
# 所以还需要配置 nginx['listen_port'] = 80 
external_url "http://47.107.245.220:8085"
nginx['listen_port'] = 80
# -----------------------------------------------------------------------------


# 配置ssh协议所使用的访问地址和端口
gitlab_rails['gitlab_ssh_host'] = '47.107.245.220'
gitlab_rails['gitlab_shell_ssh_port'] = 88
...
# 使用自己的 redis
redis['enable']=false
gitlab_rails['redis_host']='172.18.139.135'
gitlab_rails['redis_port']=6350
gitlab_rails['redis_password']='redisa$min302'
...
gitlab_rails['db_database'] = "hk_gitlab"
gitlab_rails['db_host'] = '172.18.139.135'
gitlab_rails['db_port'] = '6521'
gitlab_rails['db_username'] = 'postgres'
gitlab_rails['db_password'] = 'postresRoot9'
## Legend
